        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-gray">Description</FormLabel>
                  <FormControl>
                    <Textarea
                      {...field}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-gray">Asset</FormLabel>
                    <Select 
                      onValueChange={field.onChange} 
                      defaultValue={field.value}
                    >
                ...
                <FormItem>
                  ...
                  <div className="flex">
                    ...
                    <div className="bg-dark-bg border border-l-0 border-gray rounded-r-lg px-4 flex items-center">
                      <span className="text-white font-medium">{form.watch("token")}</span>
                    </div>
                  </div>
                  <FormDescription className="text-gray-400">
                    {form.watch("type") === "invest" 
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-gray">Voting Duration</FormLabel>
                  <Select 
                    onValueChange={field.onChange} 
                    defaultValue={field.value}
                  >
