...
// netlify/functions/ainodes-sentiments.js
var { mockData: mockData2, generateSentimentReasoning: generateSentimentReasoning2 } = (init_mockData(), __toCommonJS(mockData_exports));
exports.handler = async (event, context) => {
  ...
  if (event.httpMethod === "GET") {
    const sentiments = [];
    mockData2.aiNodes.forEach((node) => {
      mockData2.proposals.slice(0, 5).forEach((proposal) => {
        ...
        sentiments.push({
          ...
          reasoning: generateSentimentReasoning2(baseSentiment, proposal.type),
...
//# sourceMappingURL=ainodes-sentiments.js.map
