...
// netlify/functions/api-tester.js
  ...
  try {
    ...
    if (event.httpMethod === "GET") {
      ...
      const availableEndpoints = {
        "protocol-proposals": mockData2.protocolProposals,
        "protocol-metrics": mockData2.protocolMetrics,
        "leaderboard": mockData2.leaderboardParticipants,
        "ainodes": mockData2.aiNodes,
        "all": mockData2
      };
