...
export const FEATURE_FLAGS = {
  ...
  // Proposal card UI component
  useWagmiProposalCards: {
    key: 'useWagmiProposalCards',
    category: 'Governance',
    label: 'Proposal Card UI',
    description: 'Enhanced proposal cards with unified implementation',
    default: true, // Enable by default to use the unified cards
    dependencies: ['useWagmiProposals'],
  },
