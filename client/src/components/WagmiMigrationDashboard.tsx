...
export enum MigratedComponent {
  ...
  PROPOSAL_CREATION = 'ProposalCreation',
  PROPOSAL_EXECUTION = 'ProposalExecution',
  AI_NODES = 'AINodes',
  PROTOCOL_DAO = 'ProtocolDAO',
  TOKEN_INFO = 'TokenInfo',
  VOTING = 'Voting',
  ASSET_DAO_API = 'AssetDaoAPI',
  ASSET_DAO_TELEMETRY = 'AssetDaoTelemetry',
}
...
interface ApiResponse {
  ...
  assetDaoModules: {
    proposals: MigrationStatusResponse;
    voting: MigrationStatusResponse;
    telemetry: MigrationStatusResponse;
    api: MigrationStatusResponse;
  };
}
