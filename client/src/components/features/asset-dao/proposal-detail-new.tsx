...
import { InfoIcon, AlertTriangle, CheckCircle, XCircle, ArrowLeft, Copy, Check, X } from 'lucide-react';
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 border-t border-b">
            <div>
              ...
              <p className="font-medium">{TokenSymbolResolver.getTokenSymbol(proposal.token)}</p>
            </div>
            <div>
